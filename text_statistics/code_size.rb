# encoding: utf-8
# 
# Takes list of project with file filters as an input, and calculates calculates total 
# number of files, lines and characters for each projects.
# 
# Usage: 
# - edit this file and specify the projects You are interested in and file filters.
# - run it
#   $ ruby code_size.rb
#
...
projects.collect do |name, query|
  ...
  b.last <=> a.last
end.each do |name, files, lines, characters|
